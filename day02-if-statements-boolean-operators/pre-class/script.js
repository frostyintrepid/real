...
var randomDiceMain = function (input) {
  ...
  } else myOutputValue += "You Lose, Sorry!";
...
var secretPhraseMain = function (input) {
  ...
  if (input == "palatable papaya") {
    myOutputValue = "you typed in the secret phrase!";
  } else if (input == "somewhat palatable") {
    myOutputValue += "  You are nearly there!";
  } else {
    myOutputValue = "the door shall not open, try again!";
  }
  return myOutputValue;
};
